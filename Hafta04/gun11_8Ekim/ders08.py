...
# Erişim belirteçleri, kodunuzun neresinin "iç işleyiş" ve neresinin "dış arayüz" olduğunu belirtmenizi sağlar, bu da daha temiz ve 
...
print(atlet1._mgumus)


print(atlet1.__maltin)
